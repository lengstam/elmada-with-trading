...
NEIGHBOURS_CY = {
    ...
    "CH": ["AT", "DE", "FR", "IT"],
    "CZ": ["AT", "DE", "PL", "SK"],
    "DE": ["AT", "BE", "CH", "CZ", "DK", "FR", "NL", "PL", "SE4", "LU", "NO"], #removing SI and IT as data does not contain them
    "DK": ["DE", "NO", "SE3", "SE4", "NL"],
    "EE": ["FI", "LV", "RU"],
    "ES": ["FR", "PT"],
    "FI": ["EE", "NO", "RU", "SE1", "SE3"],
    ...
    "MT": ["IT"],
    "NL": ["BE", "DE", "DE", "GB", "NO"],
    "NO": ["SE1", "SE2", "SE3", "FI", "DK", "NL", "RU", "GB"],
    "PL": ["CZ", "DE", "LT", "SE4", "SK", "UA"],
    "PT": ["ES"],
    "RO": ["BG", "HU", "RS", "UA"],
...
FUEL_RENAME = {
    ...
    "Wind": "wind_onshore", #assume all wind is onshore in SE
    "Peat": "peat",
    "CHP": "chp",
    "Other non-residual mixed": "other_mixed",
    "SE Gas": "se_gas",
    "Grot": "grot",
    "SE coal": "se_coal",
    "Waste": "waste",
...
RES = ["hydro_ror", "biomass", "solar", "wind_offshore", "wind_onshore", "other_RES", "peat", "chp", "other_mixed", "se_gas", "grot", "se_coal", "hydro_res", "waste", "pumped_hydro", "nuclear"]
CONV = ["lignite", "coal", "gas", "oil", "other_conv"]
DRAF_FUELS = RES + CONV

# Fuels for calculation of residual load (simplified merit order simulation)
CONV2 = ["lignite", "coal", "gas", "oil"]
RES2 = [f for f in DRAF_FUELS if f not in CONV2]

#LINUS: These are the fuel used for residual load for the PWL method!
#removed nuclear!
# Fuels for simplified merit order simulation
PWL_FUELS = ["lignite", "coal", "gas_cc", "gas", "oil"]
